...
let suggestFrameStylesPrompt: ReturnType<typeof ai.definePrompt> | null = null;
let suggestFrameStylesFlow: ReturnType<typeof ai.defineFlow> | null = null;
...
function initializeFlows() {
  ...
  suggestFrameStylesFlow = ai.defineFlow(
    {
