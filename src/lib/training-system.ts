...
export const TRAINING_MODULES: TrainingModule[] = [
  ...
  {
    id: 'basic-001',
    title: 'Getting Started with CanvasFlow',
    titleTr: 'CanvasFlow ile Başlarken',
    description: 'Learn the fundamentals of CanvasFlow interface and navigation',
    descriptionTr: 'CanvasFlow arayüzü ve navigasyon temellerini öğrenin',
    category: 'basics',
    difficulty: 'beginner',
    estimatedMinutes: 15,
    icon: '🚀',
    ...
    steps: [
      {
        ...
        content: 'Welcome to CanvasFlow! This is your digital canvas for organizing content.',
        contentTr: 'CanvasFlow\'a hoş geldiniz! Bu, içeriği düzenlemek için dijital kanvasınızdır.',
        type: 'text',
