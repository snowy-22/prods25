...
export default function AuthPage() {
  ...
  // Check for mode, referral code and error messages in URL
  useEffect(() => {
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24 py-12">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <Link href="/" className="group">
              ...
              >
                <div className="w-11 h-11 rounded-xl flex items-center justify-center shadow-lg shadow-purple-500/30 ring-2 ring-white/20 group-hover:shadow-purple-500/50 transition-shadow overflow-hidden">
                  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
                    <rect width="100" height="100" fill="#0066cc" rx="20"/>
                    <g transform="translate(50, 50)">
                      <path d="M -20 -20 A 25 25 0 0 1 20 -20" fill="none" stroke="white" strokeWidth="6" strokeLinecap="round"/>
                      <path d="M -20 20 A 25 25 0 0 0 20 20" fill="none" stroke="white" strokeWidth="6" strokeLinecap="round"/>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="text-slate-500">
                {isSignup 
                  ? 'tv25.app ile güvenli iletişim deneyimine başla' 
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="bg-[#C8D5E8] px-4 text-slate-500">Hızlı giriş</span>
          </div>
        </div>
        ...
        <div className="mb-6">
          <Button
            type="button"
            variant="outline"
            className="w-full bg-white border-slate-300 hover:bg-slate-50 text-slate-700 shadow-sm font-medium py-6"
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-slate-300">
                          Kullanıcı Adı <span className="text-slate-500 text-xs">(opsiyonel)</span>
                        </FormLabel>
                        <FormControl>
                          <div className="relative">
                            ...
                            <Input 
                              ...
                              className="pl-10 bg-white/5 border-2 border-slate-400 text-white placeholder:text-slate-500 focus:border-indigo-600 focus:ring-indigo-600 rounded-lg py-6"
                              {...field} 
                            />
                          </div>
                        </FormControl>
                  ...
                  <FormControl>
                    <div className="relative">
                      ...
                      <Input 
                        ...
                        placeholder="••••••••" 
                        className="pl-10 pr-10 bg-white/5 border-2 border-slate-400 text-white placeholder:text-slate-500 focus:border-indigo-600 focus:ring-indigo-600 rounded-lg py-6"
                        {...field} 
                      />
                      <button
                        type="button"
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Input 
                            ...
                            className="bg-white/5 border-2 border-slate-400 text-white placeholder:text-slate-500 focus:border-indigo-600 focus:ring-indigo-600 rounded-lg py-6"
                            {...field} 
                          />
                        </FormControl>
                      ...
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel className="text-sm font-bold text-slate-800 cursor-pointer">
                            Sözleşmeler <span className="text-red-400">*</span>
                          </FormLabel>
                          <p className="text-xs text-slate-600"><a href="/terms" target="_blank" className="text-indigo-600 hover:text-indigo-700 hover:underline">Kullanım Şartları</a>, <a href="/privacy" target="_blank" className="text-indigo-600 hover:text-indigo-700 hover:underline">Gizlilik Politikası</a> ve <a href="/kvkk" target="_blank" className="text-indigo-600 hover:text-indigo-700 hover:underline">KVKK</a>'yı kabul ediyorum.</p>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel className="text-sm font-bold text-slate-800 cursor-pointer">
                            Ticari elektronik ileti alma izinleri
                          </FormLabel>
                          <p className="text-xs text-slate-600">Kampanyalar, duyurular ve ürün güncellemeleri hakkında dijital mesaj almak istiyorum.</p>
      ...
      <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-gradient-to-br from-slate-900 via-indigo-950 to-purple-950">
        ...
        <div className="absolute inset-0 flex flex-col justify-center gap-4 py-8 pointer-events-none select-none">
          ...
          <div className="px-8 mb-4 relative z-10">
            ...
            >
              <Link href="/" className="inline-flex mx-auto mb-4 group">
                <div className="w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-500/30 group-hover:shadow-purple-500/50 transition-shadow cursor-pointer overflow-hidden">
                  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
                    <rect width="100" height="100" fill="#0066cc" rx="20"/>
                    <g transform="translate(50, 50)">
                      <path d="M -20 -20 A 25 25 0 0 1 20 -20" fill="none" stroke="white" strokeWidth="6" strokeLinecap="round"/>
              ...
              <p className="text-white/60 text-sm max-w-xs mx-auto">
                Dijital Canvas'ını kendi düzeninde organize et
              </p>
            </motion.div>
          </div>
